...
class FilterAgentCardWidget extends StatefulWidget {
  ...
  @override
  State<FilterAgentCardWidget> createState() => _FilterAgentCardWidgetState();
}

class _FilterAgentCardWidgetState extends State<FilterAgentCardWidget> {
  @override
  void initState() {
          ...
          if (widget.isRisingStar == true)
            Positioned(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color(0xff003D2A), // Badge background color
