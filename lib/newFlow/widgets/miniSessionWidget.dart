...
class MiniSessionWidget extends StatelessWidget {
  VoidCallback onTap;
  MiniSessionWidget({super.key, required this.onTap});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  //   child: Text(
                  //     "Confused? Taste therapy with mini session",
                  //     maxLines: 1,
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: " Taste therapy with mini session",
                        ),
                      ],
                    ),
                  ),
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              " Let's understand the need of counseling in our daily lives.",
                        ),
                      ],
                    ),
                  ),
