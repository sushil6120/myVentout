        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              HtmlWidget(
                '''
                <h1>Overcooked app Terms and Conditions</h1>  
<p>Last Updated: 11/02/2025</p>  
<p>Welcome to Overcooked app! These terms govern your use of the Overcooked app. By accessing or using our platform, you agree to comply with these terms fully. If you do not agree, you must discontinue using the app immediately.</p>  

<h2>Overview</h2>  
<p>Overcooked app is a platform designed to facilitate connections between users and licensed psychologists or therapists. Overcooked app itself does not provide therapy services directly; it acts solely as a bridge between users and professionals.</p>  

<h2>User Obligations</h2>  
<p>By accessing the Overcooked app platform, you agree to the following responsibilities:</p>  
<ul>  
  <li>Overcooked app will not be held accountable for the quality or effectiveness of therapy services offered through the app.</li>  
  ...
  <li>Comply with applicable laws and regulations when using Overcooked app services.</li>  
...
<p>Your privacy is vital to us. Overcooked app collects and uses the following data:</p>  
<ul>  
...
<ul>  
  ...
  <li>Refrain from seeking direct contact with therapists outside of Overcooked app.</li>  
...
<p>For payment-related concerns, please contact us at overcookedapp@gmail.com.</p>  

<h2>Account Termination</h2>  
<p>Overcooked app reserves the right to suspend or terminate your account for:</p>  
<ul>  
...
<p>Overcooked app is not liable for:</p>  
<ul>  
...
<p>All content, trademarks, and materials on the app belong to Overcooked app or their respective owners. Unauthorized use is strictly prohibited.</p>  

<h2>Conduct Guidelines</h2>  
<p>Users must use Overcooked app responsibly by:</p>  
<ul>  
...
<p>The Overcooked app platform is provided "as is," without guarantees of uninterrupted or error-free functionality. We disclaim all implied warranties, including suitability for a specific purpose.</p>  

<h2>Modifications</h2>  
<p>Overcooked app may update these terms at any time. Changes will take effect upon being posted on the app. Continuing to use the platform constitutes your acceptance of the revised terms.</p>  

<h2>Contact Details</h2>  
<p>For questions about these terms, contact us at:</p>  
<ul>  
  <li>Email: overcookedapp@gmail.com</li>  
</ul>  
...
<p>These terms represent the complete agreement between you and Overcooked app regarding the use of the app, superseding prior agreements.</p>  
